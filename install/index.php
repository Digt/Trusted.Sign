...
class Trusted_Sign extends CModule
{
	...
	function Trusted_Sign()
	{
		...
		$this->MODULE_NAME = GetMessage("TSS_MODULE_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("TSS_MODULE_DESCRIPTION");
	}
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("TSS_INSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/trustedsign/install/step.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("TSS_UNINSTALL_TITLE"), $DOCUMENT_ROOT."/bitrix/modules/trustedsign/install/unstep.php");
	}
